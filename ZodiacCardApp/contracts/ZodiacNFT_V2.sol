 ...
 * @notice V2: Reduced mint fee to 2 CELO (from 10 CELO) - backward compatible
    ...
    PausableUpgradeable
{
    ...
    // Minting fee in native CELO (18 decimals) - V2: 2 CELO
    ...
    enum MintSource {
        ...
        DirectMint,      // V2: Directly minted (2 CELO) without prior image payment
        ImageToNFT       // V2: Minted after image generation (2 CELO + 2 CELO image = 4 CELO total)
    }
