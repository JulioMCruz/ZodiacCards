...
/**
 * Western Zodiac Form Component
 *
 * Collects user birth date and generates fortune based on Western zodiac signs.
...
export function WesternZodiacForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const sign = getWesternZodiacSign(dayNum, monthNum)
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <p className="text-xs text-center text-gray-600">
        Your fortune will be generated using AI based on your Western zodiac sign
      </p>
    </form>
  )
}
