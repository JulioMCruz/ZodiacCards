...
/**
 * @title ZodiacImagePayment V2
 * @dev Payment contract for Zodiac Card image generation on Celo network
 * @notice V2: Adjustable image fee (changed from constant 2 CELO)
    ...
    PausableUpgradeable
{
    ...
    // V2: Image generation fee in native CELO (18 decimals) - Now adjustable
    // MUST BE LAST: New variables placed after all existing inherited variables
    ...
    event ImageFeeUpdated(uint256 newFee); // V2: New event
    ...
    function initialize(
        ...
        imageFee = 2 ether; // V2: Initialize with 2 CELO for backward compatibility
